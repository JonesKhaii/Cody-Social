            <template id="dropdown-template-services">
                <div class="row py-4">
                    ...
                    <div class="col-md-4">
                        <h6 class="dropdown-header">Kỹ thuật nổi bật</h6>
                        ...
                        <div class="register-consultation mt-4">
                            <div class="card bg-light border-0">
                                <div class="card-body p-3">
                                    <h6 class="card-title text-primary">Đăng ký tư vấn kỹ thuật mới</h6>
                                    <p class="card-text small">Để được tư vấn về các kỹ thuật khám chữa bệnh mới phù
                                        hợp với tình trạng của bạn</p>
